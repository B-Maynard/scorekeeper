...
export default function HomePage(props) {
    ...
    return (
        <div className="container text-center">
            <div className="row">
                <HomeCard linkComponent="points" cardTitle="Point-Based Score Keeping" cardText="Useful in card games when you need to keep track of new points round-to-round." />
